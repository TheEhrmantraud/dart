...
//   print("Реальных символов: ${text.characters.length}");
...
//   Person tom = Person(name: "попа", age: 18);
//   Person tom1 = Person.withName("Писюн");

//   var dog = Dog("Лайка", "ЛАйк", 2, "Джекрасл");
//   print(dog.age);

//   var cat = Cat("Мтра", "М", 1, "Попс");

//   var rect = Rect("писяпопс");
//   rect.show();
// }
...
//     required this.name,
//     required this.age,
//   }); // конструктор с именованными полями
...
//   Animal(this.name, this.nickname, this.age);
...
//   Dog(String name, String nickname, int age, this.breed)
...
//   void tapki() {
//     print("$nickname приноит тапочки");
//   }
// }
...
//   Cat(String name, String nickname, int age, this.voice)
//     : super(name, nickname, age);
...
// class Person1 implements Person11 {
//   String name;

//   Person1(this.name);
//   @override
//   void printInfo() {
//     print("$name он идет в аквапарк");
//   }
...
// class P111 {
//   final String name;
//   static const int pensAge =
//       65; //переменная класса, меняется 1 раз меняется для всех объектов
...
//   set checkAge(int age) {
//     if (age >= pensAge) {
//       print("НА пенсии");
//     } else {
//       print("До пенсии осталось ${pensAge - age}");
//     }
//   }

//   static String runPerson(String name) {
//     return "$name ходит на работу";
//   }
// }

// void main() {
//   P111 press = P111("Анна");
//   press.printInfo();
//   press.checkAge = 18;
//   print(P111.runPerson("Володмир"));
// }
...
//   void info() => print("Person $name");
// }

// class Empl extends Person {
//   String company;
//   Empl(this.company, super.name);

//   @override
//   String get name => super.name;

//   @override
//   void info() => print("Person $name работает");
// }

// class Student extends Person {
//   String uni;
//   Student(super.name, this.uni);

//   @override
//   void info() => print("Student $name учится in $uni");
// }

// void main() {
//   Person p = Empl("Мпт", "работа");
//   p.info();

//   Person p1 = Student("Ксюша", "Плешка");
//   p1.info();
// }
...
class Crujka {
  void drink() {
    print("Пьют из кружки");
  }
}

class People {
  void drinkcrujka(Crujka crujka) {
    crujka.drink();
  }
}
...
void main() {
  ...
  print("После добавления: ${g.items}");

  g.take("Обувь");
  print("После удаления: ${g.items}");
  ...
  grif.add(b1);
  grif.add(b2);
  grif.add(b3); // превысит

  print("Общий вес: ${grif.vsego}");
